...
async function generar() {
    ...
    try {
        const response = await fetch(window.API_BASE + '/api/access/generate-manual', {
            method: 'POST',
...
async function actualizarTabla() {
    try {
        const response = await fetch(window.API_BASE + '/api/access/active');
...
async function borrar(token) {
    ...
    try {
        const response = await fetch(window.API_BASE + '/api/access/cancel', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
